...
export const InfiniteMovingCards = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "scroller relative z-20 w-screen overflow-hidden [mask-image:linear-gradient(to_right,transparent,white_20%,white_80%,transparent)] cursor-pointer",
        className
      )}
    >
      <ul
            ...
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <div className="flex justify-center items-center gap-1">
                  <div className="me-3">
                    <img src={item.profile} alt={`${item.name}'s profile`} className="w-14 h-14 rounded-full" />
                  </div>
