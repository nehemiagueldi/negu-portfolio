    ...
    <div className="py-20" id='projects'>
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-16 gap-y-8 mt-10">
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div key={id} className="sm:h-[39rem] h-[32rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vw]">
            <PinContainer title="Visit" href={link}>
              <div className="relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden sm:h-[40vh] h-[30vh] mb-10">
                ...
                <img
                  ...
                  width={465}
                  height={378}
                  className="z-10 absolute bottom-2 transform rotate-3 rounded-2xl object-cover"
                />
              </div>
