    ...
    <div className="pb-20 pt-20 md:pt-36">
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <TextGenerateEffect className="text-center text-[40px] md:text-5xl lg:text-6xl" words="About Me" duration={3} filter={false} />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 relative justify-items-center items-center my-20 z-10">
        ...
        <div>
          <GlareCard className="flex flex-col items-center justify-center">
            <img className="h-full w-full absolute inset-0 object-cover" src="/about/profileaboutme.jpg" />
          </GlareCard>
        </div>
        {/* DESC */}
        <div>
          <div className="flex flex-col items-center justify-center">
            <h1 className="text-center text-xl font-bold md:text-4xl mb-2 text-black dark:text-white">Hi, I&apos;m Nehemia Gueldi</h1>
          ...
          <div className="grid grid-cols-2 gap-10 relative justify-items-center my-10 z-10">
            <div>
              <a href="/about/Resume_Nehemia_Gueldi.pdf" target="_blank">
                <MagicButton title="Resume" icon={<GiScrollUnfurled />} position="right" otherClasses="w-full lg:w-60 transition duration-200 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50" />
              </a>
            </div>
            <div>
              <a href="https://www.linkedin.com/in/nehemiagueldi/" target="_blank">
                <MagicButton title="LinkedIn" icon={<FaLinkedin />} position="right" otherClasses="w-full lg:w-60 transition duration-200 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50" />
              </a>
            </div>
          </div>
        </div>
