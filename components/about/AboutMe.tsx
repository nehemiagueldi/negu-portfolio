  ...
  return (
    <div className="pb-20 pt-20">
      <div>
        ...
        <Spotlight className="top-10 left-full h-[60vh] md:h-[100vh] lg:h-[150vh] w-[60vw]" fill="lime" /> {/* Magenta */}
        <Spotlight className="top-28 left-80 h-[80vh] w-[50vw]" fill="#FFD700" /> {/* Gold */}
        <Spotlight className="-top-20 left-60 h-[80vh] w-[60vw]" fill="tomato" /> {/* Lavender */}
      </div>
