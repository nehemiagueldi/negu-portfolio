  ...
  return (
    <div className="py-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full">
        <WobbleCard containerClassName="col-span-1 lg:col-span-2 h-full bg-rose-800 min-h-[500px] lg:min-h-[300px]" className="">
          <div className="w-full lg:max-w-md">
            ...
            <div className="grid grid-cols-1 gap-4 justify-items-center items-center lg:justify-items-start lg:items-start">
              <div>
                ...
                <p className="max-w-[26rem] text-center lg:text-left text-base/6 text-slate-100">Aug 2020 - Aug 2024</p>
              </div>
              <div>
                <a href="#">
          ...
          <Image src="/linear.webp" width={500} height={500} alt="linear demo image" className="absolute -right-4 lg:-right-[40%] filter -bottom-10 object-contain rounded-2xl" />
        </WobbleCard>
        <WobbleCard containerClassName="col-span-1 min-h-[300px]">
          <div className="flex flex-col justify-center items-center">
            <h1 className="max-w-80 text-center text-balance text-base md:text-xl lg:text-3xl font-semibold tracking-[-0.015em] text-white">Time & Date</h1>
            <h2 className="max-w-80 text-center text-balance text-base md:text-xl lg:text-3xl font-semibold tracking-[-0.015em] text-white mt-2">{currentTime}</h2>
            <p className="max-w-[26rem] text-center text-base/6 text-slate-200">{currentDate}</p>
